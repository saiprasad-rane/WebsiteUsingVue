<template>
  <div class="content">
    ...
    <div class="top-row">
      <div class="top part">
        <div class="robot-name">
          {{selectedRobotPart.head.title}}
          <span class="sale" v-if="selectedRobotPart.head.onSale">Sale!</span>
        </div>
        <img :src="selectedRobotPart.head.src" title="head" />
    ...
    <div class="middle-row">
      <div class="left part">
        <img :src="selectedRobotPart.leftArm.src" title="left arm" />
        <button @click="selectPreviousLeftArm()" class="prev-selector">&#9650;</button>
        <button @click="selectNextLeftArm()" class="next-selector">&#9660;</button>
      </div>
      <div class="center part">
        <img :src="selectedRobotPart.torso.src" title="torso" />
        <button @click="selectPreviousTorso()" class="prev-selector">&#9668;</button>
        <button @click="selectNextTorso()" class="next-selector">&#9658;</button>
      </div>
      <div class="right part">
        <img :src="selectedRobotPart.rightArm.src" title="right arm" />
    ...
    <div class="bottom-row">
      <div class="bottom part">
        <img :src="selectedRobotPart.base.src" title="base" />
...
export default {
  ...
  methods: {
    addToCart() {
      const robot = this.selectedRobotPart;
